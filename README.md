...
Prototype catalogue product pages on the public site may still use mock stock. Admin Catalogue products persist in Postgres: add, edit, delete, and CSV upload/export.
