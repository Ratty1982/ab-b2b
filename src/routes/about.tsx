...
const FALLBACK = marketingCmsPageBySlug("about")!;

export const Route = createFileRoute("/about")({
  loader: async () => {
    const result = await getPublicCmsPageFn({ data: { slug: "about" } });
...
function About() {
  ...
  return <PublicCmsPage page={page} breadcrumbs={[{ label: "Home", to: "/" }, { label: "About Us" }]} />;
}
