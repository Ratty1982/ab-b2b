...
export const customers = [
  ...
  },
  {
    ...
    ytd: 29105,
    openOpps: 3,
    nextActivity: "Quote follow-up — 16 Sep",
    status: "Active",
    risk: "High value",
  },
  {
    ...
    ytd: 0,
    openOpps: 1,
    nextActivity: "Intro call — 18 Sep",
    status: "Prospect",
    risk: "New customer",
  },
  {
...
export const promos = [
  { code: "PM-AUTUMN", title: "Power Maxed braking — extra 5% on 12+", ends: "30 Sep" },
  { code: "SS-CASE24", title: "Steel Seal RTV case deals from £3.90", ends: "14 Oct" },
  { code: "BP-WINTER", title: "Bramley battery winter stock-up", ends: "31 Oct" },
];
